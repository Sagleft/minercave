...
var rawPoolDiff = []byte{0, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
	255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255}
var DiffOne *big.Int
var PoolDiff *big.Int

func init() {
	DiffOne = big.NewInt(0)
	DiffOne.SetBytes(rawDiffOne)
	PoolDiff = big.NewInt(0)
	PoolDiff.SetBytes(rawPoolDiff)
}
